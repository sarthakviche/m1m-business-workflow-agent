...
from sqlalchemy import text, ForeignKey, UniqueConstraint, CheckConstraint, Date
...
class Invoice(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("status IN ('unpaid','partially_paid','paid')", name="invoice_status_check"),
        CheckConstraint(
    ...
    quotation_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True),
    ...
    cgst_amount: Mapped[Decimal] = mapped_column(Numeric(14, 2), server_default="0", nullable=False)
    sgst_amount: Mapped[Decimal] = mapped_column(Numeric(14, 2), server_default="0", nullable=False)
    igst_amount: Mapped[Decimal] = mapped_column(Numeric(14, 2), server_default="0", nullable=False)
    ...
    tally_push_status: Mapped[str] = mapped_column(Text, nullable=False,
